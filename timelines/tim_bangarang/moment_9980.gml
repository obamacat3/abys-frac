...
{
					FSKJKFSFSJK1 = shootFixRain("down", par_bullet, "", 3)
	...
	var f =quickLazer(aimerMiddle_1.x,aimerMiddle_1.x, followerMid.x, followerMid.y + 100, 1,,100);  //have to reduce by 100	
